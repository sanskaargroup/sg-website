        ...
        >
            <div className="corporate-event">
                ...
                <div className="ce-intro">
                    <h2>
                        Corporate Events to our Credit pertaining to Co
                ...
                <div className="year-wise">
                    ...
                    <div className="year1 , eventcard">
                        ...
                        <div className="year0-content">
                            ...
                            <ul>
                                <li>
                                    India – Kyrgyz Health Co – Operation
                                    Programme 2017Bishkek, Kyrgyzstan
                                </li>
                                ...
                                <li>
                                    International Conference on Medical Tourism
                                    2018: Tehran, Iran
                                </li>
                                <li>WED 2018</li>
                                <li>IPHEX 2018</li>
                    ...
                    <div className="gallery">
                        ...
                        <button
                            onClick={() => {
                                window.open(
                                    'https://drive.google.com/drive/folders/1O_nqTlg1auvXx6gTNnPCXxMo9SS9-Lm7?usp=drive_link'
                                );
                            }}
                        >
