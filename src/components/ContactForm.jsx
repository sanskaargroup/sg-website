	...
	return (
		<div className="contact-form-container" style={{backgroundImage: `url(${BackgroundImage})`}}>
			<div className="contact-form">
				<h2>
					If you have any questions, please feel free to drop me a line. We will get back to you as soon as we can.
					Thats a promise!
				</h2>
				<form onSubmit={handleSubmit}>
					...
					<div>
						<input type="number" placeholder="Phone" name="phone" onChange={handleChange} className="form-input" />
					...
					<div>
						<input type="text" placeholder="City" name="city" onChange={handleChange} className="form-input" />
					...
					<div>
						<select type="string" name="country" placeholder="Country" onChange={handleChange} className="form-input">
