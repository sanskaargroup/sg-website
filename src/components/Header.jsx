...
export const Header = () => {
    ...
    const toRotate = [
        'Welcome to Sanskaar Group',
        'We handle ,  You make memories',
    ];
                        ...
                        <TrackVisibility>
                            {({ isVisible }) => (
                                ...
                                >
                                    ...
                                    <p>
                                        Established in 2013, Sanskaar is
                                        renowned for its personalized event
                                        management services, catering to
                                        corporate and social events. With
                                        fully-equipped in-house production
                                        facilities and offices in Noida and
                                        Gurugram, our global presence in the
                                        Middle East and CIS countries enables us
                                        to deliver exceptional, tailor-made
                                        event solutions, ensuring every event is
                                        a success.
                                    </p>
